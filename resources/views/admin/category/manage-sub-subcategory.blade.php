    ...
    <div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><a href="javascript:avoid(0)">Manage Sub Sub Category</a></li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="panel-content d-flex justify-content-center">
                        <div class="row">
                            <div class="col-sm-10 text-center ">
                                <h4>Manage Sub Sub Category Form</h4>
                            </div>
                            <div class="col-sm-2">
                                <a href="{{route('add-sub-subcategory')}}" class="btn btn-primary">Add Sub Sub Category</a>
                            </div>
                        </div>
                                    ...
                                    <div class="panel-content">
                                        <div class="table-responsive ">
                                            <table id="basic-table" class="data-table table table-striped nowrap table-hover table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    <th>Serial No</th>
                                                    <th>Root Category > Sub Category > Sub Sub Category</th>
                                                    <th>Status</th>
                                                    <th>Action</th>
                                                </tr>
                                                </thead>
