                            ...
                            <div class="col-md-12">
                                <form class="form-horizontal" method="POST" action="{{route('update-category')}}">
                                    ...
                                    <div class="form-group">
                                        <label for="brand_name" class="col-sm-2 control-label">Category Name</label>
                                        <div class="col-sm-10">
                                            <input type="hidden" name="id" value="{{$row['id']}}">
                                            <input type="text" class="form-control" name="category" value="{{$row['category']}}" id="brand_name" placeholder="Brand Name"data-validation="required">
                                            @error('category')
